...
<html lang="en">
 ...
 <a href="javascript:void(0);" data-toggle="modal" data-target="#view_league_Scores"  class="view_leader_board"><input type="hidden" name="leader_id" id="leader_id" ></a>
...
$matchLiveArray = json_decode($json_string_result,true);
                        ...
                        <input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                         ...
                         <input type="hidden" name="money_line_opponent" id="money_line_opponent" value="<?php  echo $resultsLive['MoneyLineAway']; ?>">
                             ...
                             <table class="table borderless <?php  echo $class; ?>">
								...
								<tbody>
                                  <tr >
									<td><?php echo $mydataLive['HomeTeam'] ?> (Home Team)</td>
									<td class="link-show"><button class="btn <?php if($pointsHome>$pointsAway){?>bet<?php } else{ echo 'unbet';} ?>" id="home" data-id="<?php echo $id; ?>"> <?php  echo $resultsLive['PointSpreadHome']; ?> (<?php  echo $resultsLive['PointSpreadHomeLine']; ?>)</button>
                                  <?php if($pointsHome>$pointsAway){?> (Underdog)<?php } ?>  
                                    </td>
								  ...
								  <tr>
									...
									<td class="link-show"><button class="btn <?php if($pointsAway>$pointsHome){?>bet<?php } else{ echo 'unbet';} ?>"  id="away" data-id="<?php echo $id; ?>"><?php  echo $resultsLive['PointSpreadAway']; ?> (<?php  echo $resultsLive['PointSpreadAwayLine']; ?>)</button>
                                     <?php if($pointsAway>$pointsHome){?> (Underdog)<?php } ?> 
                                    </td>
    ...
    <div>&nbsp;</div>
     ...
     <div id="mypicksdata">My Picks</div>
