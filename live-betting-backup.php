                             ...
                             <table class="table borderless <?php  echo $class; ?>">
								...
								<tbody>
                                  <tr >
									...
									<td class="link-show"><button class="btn bet" id="home" data-id="<?php echo $id; ?>"> <?php  echo $resultsLive->PointSpreadHome; ?> (<?php  echo $resultsLive->PointSpreadHomeLine; ?>)</button></td>
