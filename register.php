  ...
  <body>
			...
			<form class="register-form" id="signup_form" method="post" action="">
				...
				<div class="form-box">
                    <label>
                        ...
                        <input type="text" name="league_name" id="league_name" value="" class="validation_chk" placeholder="League Name" >
                   ...
                   <!--  <label>
					...
					<label>
						...
						<input type="email" value="" name="email" id="email" placeholder="Email address" class="validation_chk">
					</label>
	...
	<script>
	 ...
	 $('body').click(function(e){
	  ...
	  $("#league_name,#first_name,#last_name,#username,#password,#re_password,#email,#email_forgot,#alert_msg_forgot").val('');
	  $('.error_msg').html("");
	  $('.error_msg').hide();
		...
		else
		{
		 ...
		 $.ajax({
				...
				success: function(data) {
					...
					$("#league_name,#first_name,#last_name,#username,#password,#re_password,#email").val('');
					if(data=='success')
					{
						/*$('#succ_msg').show();
				  ...
				  $.ajax({
						...
						success: function(data) {
							...
							if(data=='Failed')
							{
							 ...
							 $('#username_errorMsg').html('This user name has already taken.');
							 $('#username').focus();
							 $('#username').css("border-color","red");
							}
							else
