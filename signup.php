			...
			<form class="register-form" id="signup_form" method="post" action="">
				...
				<div class="form-box">
					...
					<label>
						...
						<input type="text"  name="email" id="email" placeholder="Email address" <?php if($receiver_email!=''){ ?> class=""<?php }  ?> value="<?php echo $receiver_email; ?>" <?php if($receiver_email!=''){ ?>readonly<?php }  ?>>
					</label>
