...
include('db.php');
	...
	$check=@mysql_query("select * from invites where receiver_email='$receiver_email' and accepted=1 and league_id='$league_id'");
	$num=@mysql_num_rows($check);
	
	if($num==0){
	
	$inviteSql=@mysql_query("update invites set accepted=1 where receiver_email='$receiver_email' and league_id='$league_id'");
