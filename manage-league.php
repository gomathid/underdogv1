						 ...
						 <table class="table borderless lobby table-hover" id="myTable" data-tableName="Users Table ">
							...
							?>
                              ...
                              <tr>
								...
								<td>
                                <?php  if($status==1){?>
                                <a href="#" data-toggle="modal" data-target="#remove-league" class="edit-btn del_league" data-id="<?php echo $data['id']; ?>" data-tooltip="Stop League" style="outline:none; text-decoration:none;"><span class="fa fa-ban"></span></a>&nbsp;
                                <?php }else {  ?>
                                <a href="#" data-toggle="modal" data-target="#activate-league" class="edit-btn act_league"  data-id="<?php echo $data['id']; ?>" data-tooltip="Activate League" ><span class="fa fa-check-circle" style="outline:none; text-decoration:none;"></span></a>&nbsp;
                                <?php } ?>
                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#players-remove" class="delete-btn playerdetails" data-id="<?php echo $data['id']; ?>" data-tooltip="View Players" style="outline:none; text-decoration:none;" ><span class="fa fa-user-times"></span></a>&nbsp;
                                 <a href="javascript:void(0);" data-toggle="modal" data-target="#viewDetails"  class="btn-com details" data-id="<?php echo $data['id']; ?>" data-tooltip="View" title="View" style="outline:none; text-decoration:none;"><span class="fa fa-eye"></span></a></td>
							  </tr>
                                <?php  } ?>
							  <?php  } ?>
                              <?php } else  { ?>
	  ...
	  <div class="modal fade" id="players-remove" role="dialog">
		<div class="modal-dialog">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			    <div class="admin-table table-responsive" id="players_details" >
	...
	$('body').tooltip({
	 ...
	 $("body").delegate("#end_date", "focusin", function(){
	  ...
	  $(function() {
		...
		$("body").find("#playerTable").DataTable();
